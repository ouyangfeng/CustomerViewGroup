 ...
 *         <p/>
 *         viewPager 顶部tab导航 <a
 *         href="https://github.com/astuetz/PagerSlidingTabStrip">gitHub 源码</a>
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int underlineColor = 0xFFd8cbcb;
    ...
    private int tabBackgroundResId = R.drawable.sgk_background_tab;

    private Locale locale;

    private int compoundTabIndex = -1;
    private Drawable compoundDrawable = null;
    ...
    public void addCompoundDrawable(int index, Drawable d) {
        this.compoundTabIndex = index;
        this.compoundDrawable = d;
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            } else if (pager.getAdapter() instanceof IuserHomeNav) {
                IuserHomeNav homeNav = (IuserHomeNav) pager.getAdapter();
                addTextTab(i, homeNav.getTitle(i));
            } else {
    ...
    private void addTextTab(final int position, String title) {
        ...
        tab.setSingleLine();
        // add arrow
        if (compoundTabIndex != -1 && compoundDrawable != null && position == compoundTabIndex) {

            int h = DensityUtil.dip2px(getContext(), tabTextSize - 2);

            compoundDrawable.setBounds(0, 0, h / 3, h);

            tab.setCompoundDrawables(null, null, compoundDrawable, null);
        }
        addTab(position, tab);
    }
    ...
    public void updaTab(final int position, SpannableString spannableString) {
